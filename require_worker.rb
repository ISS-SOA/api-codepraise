...
# Worker has its own domain (contributions), infrastructure (git), and services separate from the API
# Params:
...
def require_worker(folders = %w[domain infrastructure services])
